...
# ./bws -L 257 -N 1000 -h 0.2 -p 0.25 -q 0.25 > BARW/data_h_0.4_p_0.25_q_0.25.txt 
SEED=1500 # Starting seed
...
p=0.8 # prob. of hopping in the same direction as the previous hop 
q=0.1 # prob. of hopping to one of the two orthogonal directions.
